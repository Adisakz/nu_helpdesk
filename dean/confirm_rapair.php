...
$id_head_klung = $row['id_head_klung'];
                                ...
                                <form id="quickForm" action="confirm_repair_save" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="show_department" class="form-control"
                                                value="<?php echo name_department($departmentName)?>" readonly>
                                            <input type="text" name="department-id" id="department-id"
                                                value="<?php echo $departmentName?>" hidden>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="recomment" class="form-control" id="recomment"
                                                readonly><?php echo $recomment ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="repair-type-tech">ประเภทการซ่อม</label>
                                            <input type="text" name="repair-type-tech" class="form-control" id="repair-type-tech"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="show_name_tech" class="form-control"
                                                value="<?php echo name_person($tech_id)?>" readonly>
                                            <input type="text" name="tech-name" id="tech-name"
                                                value="<?php echo $tech_id?>" hidden>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="inspector_name1" class="form-control"
                                                id="inspector_name1" value="<?php echo $inspector_name_1?>"
                                                readonly><br>
                                            <input type="text" name="inspector_name2" class="form-control"
                                                id="inspector_name2" value="<?php echo $inspector_name_2?>"
                                                readonly><br>
                                            <input type="text" name="inspector_name3" class="form-control"
                                                id="inspector_name3" value="<?php echo $inspector_name_3?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="id-head">หัวหน้าหน่วย</label>
                                            <input type="text"  class="form-control" 
                                                value="<?php echo name_person($id_head)?>" readonly>
                                                <input type="text" name="id-head" value="<?php echo $id_head?>" hidden>
                                        </div>
                                        <div class="form-group">
                                            <img src="../image_signature/<?php echo $signature_head; ?>"
                                                alt="signature_head" width="180px">
                                        </div>
                                        <div class="form-group">
                                            <label for="id-head-klung">หัวหน้ากองคลัง</label>
                                            <input type="text"  class="form-control" 
                                                value="<?php echo name_person($id_head_klung)?>" readonly>
                                                <input type="text" name="id-head-klung" value="<?php echo $id_head_klung?>" hidden>
                                        </div>
                                        <div class="form-group">
                                            <img src="../image_signature/<?php echo $signature_head_klung; ?>"
                                                alt="signature_head_klung" width="180px">
                                        </div>
                                        <div class="form-group">
                                            <label for="id-director">ผู้อำนวยการ</label>
                                            <input type="text"  class="form-control" 
                                                value="<?php echo name_person($id_director)?>" readonly>
                                                <input type="text" name="id-director" value="<?php echo $id_director?>" hidden>
                                        </div>
                                        <div class="form-group">
                                            <img src="../image_signature/<?php echo $signature_director; ?>"
                                                alt="signature_director" width="180px">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    ...
                                    <div class="card-footer d-flex justify-content-end">
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            onclick="cancelRepair()">ไม่อนุมัติ</button>&nbsp&nbsp
