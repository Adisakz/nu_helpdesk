...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('a[name="repair"]').classList.add('nav-link', 'active');
        });
        </script>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control-plaintext" name="asset-id-new"
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control-plaintext" id="name-asset"
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control-plaintext" id="brand"
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control-plaintext" id="model"
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control-plaintext" id="building"
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control-plaintext" id="room-number"
                                                                name="room-number"
