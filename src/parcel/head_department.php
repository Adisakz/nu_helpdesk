    ...
    <section class="content">
      ...
      <div class="card card-solid">
        <div class="card-body pb-0">
          <div class="row">
            <?php
               $sqlCount = "SELECT COUNT(*) AS total FROM account WHERE (urole = 'หัวหน้าหน่วย' OR urole = 'พัสดุ') AND department = '$departmentid'";
               ...
               $sql = "SELECT * FROM account WHERE (urole = 'หัวหน้าหน่วย' OR urole = 'พัสดุ') AND department = '$departmentid' LIMIT $offset, $recordsPerPage";
