...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const typeParcelNavItem = document.querySelector('a[name="confirm-req"]')
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0" style="margin: 10px 10px 0 10px;">
                        ...
                        <table class="table table-striped projects" cellspacing="0" width="100%"
                                ...
                                <tbody>
                                <?php $sql = "SELECT * FROM report_req_parcel where status = '2' ";
                                      ...
                                      if ($result) {
                                          ...
                                          while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<a class="btn btn-success btn-sm" href="./confirm_parcel?id=' .$row['id'] . '"><i class="fas fa-pencil-alt"></i> ตรวจสอบ</a>&nbsp';
                                            echo '</td>';
                                            echo '</tr>';
                                        }
                                      } else {
