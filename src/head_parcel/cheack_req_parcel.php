                ...
                <div class="card">
                    ...
                    <div class="card-body p-0" style="margin: 10px 10px 0 10px;">
                        ...
                        <table class="table table-striped projects" cellspacing="0" width="100%"
                                ...
                                <tbody>
                                <?php $sql = "SELECT * FROM report_req_parcel WHERE status = '1' OR status = '3'";
                                      ...
                                      if ($result) {
                                          ...
                                          while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if($row['status'] == '1'){
                                            echo '<a class="btn btn-success btn-sm" href="./cheack_parcel?id=' .$row['id'] . '"><i class="fas fa-pencil-alt"></i> ตรวจสอบ</a>&nbsp';
                                            }else{
