            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <input type="text" name="building" value="<?php echo $building?>" style="display: none; ">
                    <label for="building">อาคาร : <span style="color: #28a745;"><?php echo htmlspecialchars($building); ?></span></label>
                  </div>
                  <div class="form-group">
                  <input type="text" name="room-number" value="<?php echo $room_number?>" style="display: none; ">
                    <label for="room-number">ห้อง : <span style="color: #28a745;"><?php echo htmlspecialchars($room_number); ?></span></label>
                  </div>
                  <div class="form-group">
